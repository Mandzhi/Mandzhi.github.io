...
1. [Practical aspects of absolute permeability finding for the lattice Boltzmann method and pore network modeling](https://www.sciencedirect.com/science/article/abs/pii/S0378437121005227)
<img src="iimages/image2.jpg?raw=true"/>
...
### My popular Medium and TDS posts {#examples}

My 3 Medium posts were chosen for the Boost programs. It allowed to increase the total views up to 40k.

- [Introduction to Unit Testing](https://python.plainenglish.io/introduction-to-unit-testing-d7c1fb0ee2ea): a quick guide on how to create a SQLite database and test it with unit testing in Python.
- [On the Way to Becoming a Multi-Language Programmer](https://radmilamandzhi.medium.com/on-the-way-to-becoming-a-multi-language-programmer-a894d368c7f8): my personal findings on comparing 3 simple operations in Julia and Python.
- [How to draw diagrams using Mermaid.js](https://ai.gopubby.com/how-to-draw-diagrams-using-mermaid-js-97c41f814bbd): a step-by-step tutorial to creating better flowcharts and block schemes using Mermaid.js.
- [Apply Sphinx’s Functionality to Create Documentation for Your Next Data Science Project](https://towardsdatascience.com/apply-sphinxs-functionality-to-create-documentation-for-your-next-data-science-project/): the post contains three most impressive functionalities of Sphinx’s tool, which can automatically generate documentation for Python modules.
- [Get Things Done: Five Actionable Steps to Amplify Your Productivity](https://code.likeagirl.io/get-things-done-five-actionable-steps-to-amplify-your-productivity-9ec628499677): a post with few simple (yet powerful!) rules to be more productive at work, regardless of whether your projects are related to data science or not.

---

### Other writing samples {#writing}

1. While working @ Changellenge >> I created engaging tasks with solutions for a virtual IT internship Shift + Enter for students who want to enter IT in non-IT fields (banking, pharmaceuticals, telecom, FMCG, etc.). Below examples of these tasks are given:
